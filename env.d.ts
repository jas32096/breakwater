/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 95b94f5058b75f5e5b00d40ea3f682d8)
// Runtime types generated with workerd@1.20260828.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	BreakwaterAgent: DurableObjectNamespace<import("./src/server").BreakwaterAgent>;
	ROLLOUT_WORKFLOW: Workflow<Parameters<import("./src/server").RolloutWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "BreakwaterAgent";
	}
